...
<body>
    ...
    <script>
        ...
        function addBotMessage(message) {
            ...
            answeredBy.innerHTML = "Answered by Shoe-AI";
        ...
        function sendMessage() {
            ...
            const messageCallAPI =
                "Chỉ trả lời các câu hỏi liên quan đến giày. Viết thành đoạn văn và loại bỏ tất cả ký tự đặc biệt khỏi câu trả lời." +
                message;
            if (message === "") return;
